...
#### 輸入方案插件：lua_filter@reformat_comment_filter
...
【輸入方案】預設之【輸出】為：【漢字】，使用【按鍵】為：【空白】鍵。

輸入方案不僅提供【漢字】之輸出，亦提供輸出：**【漢字標音】**（如：十五音、方音符號、台語音標...等），使用按鍵為：【**enter**】鍵。

#### 輸入方案可用之【輸出控制按鍵】

【輸入方案】可提供之輸出，不僅有【空白】鍵、【Enter】鍵，還有下列各式之【輸出控制按鍵】：

- `space` → 漢字
- `enter (commit_composition)` →
    - 預設：字典的羅馬拼音字母：hu5
    - 可手動切換其它之【漢字標音法】
- `ctrl+enter (commit_script_text)` → 【輸入編輯列】顯示的【漢字標音法】==》【十五音】：喜艍五
...
ime --> user : 輸出【漢字標音】：<font color=blue>ㄌㄨㄣˋ</font>（【漢字標音輸出】選項的【預設】）
end
...
autonumber resume "<font color=red><b>0"
partition #LightGrey 以【漢字標音輸出】之【預設】輸出【漢字標音】
user -> ime: 輸入【台語音標】：<font color=red>lun2</font>
user -> ime : 移動【選擇游標】選擇【項目】：<font color=blue><b>忍 〔居二柳〕【ㄌㄨㄣˋ】</b></font>
user -> ime : 按<font color=red>【Enter】</font>鍵
ime --> user : 輸出【漢字標音】：<font color=red>ㄌㄨㄣˋ</font>（【漢字標音輸出】選項的【預設】）
end

partition #LightGrey 切換【漢字標音輸出】設定為【台羅拼音】
user -> ime : <font color=red><b>按 [Ctrl] + [`] 鍵，進入【輸入方案】之選項切換功能</b></font>
user -> ime : 將【漢字標音輸出】選項切換成<font color=red><b>【台羅拼音】</b></font>
...
partition #LightGrey 切換【漢字標音輸出】設定為【閩拼方案】
user -> ime : <font color=red><b>按 [Ctrl] + [`] 鍵，進入【輸入方案】之選項切換功能</b></font>
user -> ime : 將【漢字標音輸出】選項切換成<font color=red><b>【閩拼方案】</b></font>
...
1. 上述操作步驟【1-2】，輸入漢字之【台語音標】：lun2；

    - 【鍵盤】按鍵：【l】【u】【n】【\】
    - 【輸入編輯列】顯示： `【柳君二】`
    - 【候選清單】挑選： `忍  【君二柳】〔lun2〕`

2. 上述操作步驟【3-8】，描述如何借由【輸出按鍵】，決定輸出為【漢字】或【漢字標音】...
    - 按【空白】鍵：輸出漢字：【忍】
    - 按【enter】鍵：輸出`預設`的【漢字標音】：`台語音標`，即：`lun2`。

3. 上述操作步驟【9-10】，描述如何變更`輸出【漢字標音】選項`，將【預設】之【台語音標】，切換成【方音符號】；

4. 上述操作步驟【11-14】，描述：經`輸出【漢字標音】選項`之變更，按【enter】鍵，可得輸出為【方音符號】：`ㄌㄨㄣˋ`。
...
user -> ime : 輸入完整之【台語音標】：【l】、【u】、【n】、【\】
ime --> user : 【輸入編輯列】顯示【聲+韻+調】：【柳】+【君】+【二】
ime --> ime : 【候選清單】顯示符合【聲】+【韻】+【調】的【漢字】及【漢字標音】\n（左欄：【十五音】、右欄：【台語音標】）
...
alt#Gold #LightBlue 輸出：【漢字】
    ...
    user -> ime : 按【Enter】鍵
    ime --> user : 輸出【漢字標音輸出】：君二柳
else #LightGrey 輸出：【輸入編輯列】之【漢字標音】
    user -> ime : 按【Ctrl + Enter】鍵
    ime --> user : 輸出【輸入法】之【漢字拼音】：柳君二
else #LightBlue 輸出：【候選清單】右欄之【漢字標音】
    user -> ime : 按【Shift + Enter】鍵
    ime --> user : 輸出【候選清單】左欄之【漢字拼音】：lun2
else #Pink 輸出：【輸入編輯列】之【漢字標音】
    user -> ime : 按【Shift + Ctrl + Enter】鍵
    ime --> user : 輸出【候選清單】之【漢字拼音】：【君二柳】〔lun2〕
end
...
按【Enter】鍵，輸出【漢字標音】，可由輸入方案的`【輸出漢字標音選項】`，進行設定及切換。
...
editor:
  bindings:
    Return: commit_composition                # 預設：字典的羅馬拼音字母：hu5
                                              # 可手動切換其它之【漢字標音法】
    Shift+Return: commit_raw_input            # 【輸入編輯列】接收到的【按鍵】輸入
    Control+Return: commit_script_text        # 【輸入編輯列】顯示的【漢字標音法】==》【十五音】：喜艍五
    Shift+Control+Return: commit_comment      # 【候選清單】的【漢字標音】：**〔喜艍五〕【hu5】**
